<template>
    <div class="assignments-container">
        ...
        <div class="assignments-content">
            ...
            <div class="assignments-main" v-if="assignment">
                <div class="header-section">
                    <button class="back-btn" @click="goBack">
                        <i class="pi pi-arrow-left"></i> Back to Assignment
                    </button>
                        ...
                        <div v-for="submission in submissions" :key="submission.submission_id" class="submission-card">
                            ...
                            <div class="submission-details">
                                ...
                                <div class="score" v-if="submission.grade !== null">
                                    ...
                                    <span class="score-value">{{ submission.grade }}/{{ assignment.total_points }}</span>
                                </div>
                            </div>
...
export default {
    ...
    methods: {
        ...
        async fetchSubmissions() {
            ...
            try {
                const assignmentId = this.$route.params.assignmentId;
                const response = await axios.get(`http://127.0.0.1:8000/api/assignment_submissions/${assignmentId}`);
    ...
    beforeRouteEnter(to, from, next) {
        next(vm => {
            if (from.name === 'AssignmentSubmissionDetails') {
                vm.fetchSubmissions();
            }
        });
    }
