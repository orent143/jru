<template>
    <div class="submissions-container">
        ...
        <div class="submissions-content">
            ...
            <div class="submissions-main" v-if="quiz">
                <div class="header-section">
                    <button class="back-btn" @click="goBack">
                        <i class="pi pi-arrow-left"></i> Back to Quiz
                    </button>
                    <h1>{{ quiz.title }} - Submissions</h1>
                </div>
                        ...
                        <div v-for="submission in submissions" :key="submission.submission_id" class="submission-card">
                            ...
                            <div class="submission-details">
                                ...
                                <div class="score" v-if="submission.grade !== null">
                                    ...
                                    <span class="score-value">{{ submission.grade }} / {{ quiz.total_points }}</span>
                                </div>
                            </div>
...
export default {
    ...
    methods: {
        ...
        async fetchSubmissions() {
            ...
            try {
                const quizId = this.$route.params.quizId;
                const response = await axios.get(`http://127.0.0.1:8000/api/quiz_submissions/${quizId}`);
    ...
    beforeRouteEnter(to, from, next) {
        next(vm => {
            if (from.name === 'QuizSubmissionDetails') {
                vm.fetchSubmissions();
            }
        });
    }
