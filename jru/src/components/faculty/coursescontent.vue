<template>
  ...
  export default {
            ...
            materials: [
              {
                ...
                dueDate: '2024-02-16',
                status: 'Pending',
                attachments: [{ id: 1, name: 'calculus_intro.pdf', type: 'pdf' }]
              }
            ],
            students: [
              { id: 1, name: 'John Smith' },
            ...
            materials: [
              {
                ...
                description: 'Basic grammar rules and usage',
                datePosted: '2024-02-04',
                dueDate: '2024-02-20',
                status: 'In Progress',
                attachments: [{ id: 1, name: 'grammar_fundamentals.pdf', type: 'pdf' }]
              }
            ],
            students: [
              { id: 1, name: 'John Smith' },
    ...
    course() {
      ...
      if (!foundCourse) {
        this.$router.push('/student-dashboard'); // Redirect to dashboard if course is not found
        return null;
      }
      return foundCourse;
    }
