...
const routes = [
  ...
  { path: '/student/course/:courseId', name: 'CourseContent', component: CourseContent, props: true },
  { path: '/student/course/:courseId/material/:materialId', name: 'MaterialDetail', component: FacultyCourseMaterialDetail, props: true },
